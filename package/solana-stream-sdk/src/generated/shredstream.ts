...
export const Heartbeat: MessageFns<Heartbeat> = {
  ...
  fromJSON(object: any): Heartbeat {
    return {
      ...
      regions: globalThis.Array.isArray(object?.regions)
        ? object.regions.map((e: any) => globalThis.String(e))
        : [],
    }
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Heartbeat>, I>>(
    ...
    const message = createBaseHeartbeat()
    message.socket =
      object.socket !== undefined && object.socket !== null
...
export const TraceShred: MessageFns<TraceShred> = {
  ...
  fromPartial<I extends Exact<DeepPartial<TraceShred>, I>>(
    object: I,
  ): TraceShred {
    const message = createBaseTraceShred()
...
export const SubscribeEntriesRequest: MessageFns<SubscribeEntriesRequest> = {
  encode(
    ...
    Object.entries(message.accounts).forEach(([key, value]) => {
      SubscribeEntriesRequest_AccountsEntry.encode(
        { key: key as any, value },
        writer.uint32(10).fork(),
      ).join()
    })
    Object.entries(message.transactions).forEach(([key, value]) => {
      SubscribeEntriesRequest_TransactionsEntry.encode(
        { key: key as any, value },
        writer.uint32(26).fork(),
      ).join()
    })
    Object.entries(message.slots).forEach(([key, value]) => {
      SubscribeEntriesRequest_SlotsEntry.encode(
        { key: key as any, value },
        writer.uint32(18).fork(),
      ).join()
    })
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          const entry1 = SubscribeEntriesRequest_AccountsEntry.decode(
            reader,
            reader.uint32(),
          )
        ...
        case 3: {
          ...
          const entry3 = SubscribeEntriesRequest_TransactionsEntry.decode(
            reader,
            reader.uint32(),
          )
        ...
        case 2: {
          ...
          const entry2 = SubscribeEntriesRequest_SlotsEntry.decode(
            reader,
            reader.uint32(),
          )
  ...
  create<I extends Exact<DeepPartial<SubscribeEntriesRequest>, I>>(
    base?: I,
  ): SubscribeEntriesRequest {
    return SubscribeEntriesRequest.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<SubscribeEntriesRequest>, I>>(
    object: I,
  ): SubscribeEntriesRequest {
    const message = createBaseSubscribeEntriesRequest()
...
export const SubscribeEntriesRequest_AccountsEntry: MessageFns<SubscribeEntriesRequest_AccountsEntry> =
  {
    encode(
      message: SubscribeEntriesRequest_AccountsEntry,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
      if (message.key !== '') {
    ...
    create<
      I extends Exact<DeepPartial<SubscribeEntriesRequest_AccountsEntry>, I>,
    >(base?: I): SubscribeEntriesRequest_AccountsEntry {
      return SubscribeEntriesRequest_AccountsEntry.fromPartial(
        base ?? ({} as any),
      )
    },
    fromPartial<
      I extends Exact<DeepPartial<SubscribeEntriesRequest_AccountsEntry>, I>,
    >(object: I): SubscribeEntriesRequest_AccountsEntry {
      const message = createBaseSubscribeEntriesRequest_AccountsEntry()
...
export const SubscribeEntriesRequest_TransactionsEntry: MessageFns<SubscribeEntriesRequest_TransactionsEntry> =
  {
    encode(
      message: SubscribeEntriesRequest_TransactionsEntry,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
      if (message.key !== '') {
        writer.uint32(10).string(message.key)
    ...
    create<
      I extends Exact<
        DeepPartial<SubscribeEntriesRequest_TransactionsEntry>,
        I
      >,
    >(base?: I): SubscribeEntriesRequest_TransactionsEntry {
      return SubscribeEntriesRequest_TransactionsEntry.fromPartial(
        base ?? ({} as any),
      )
    },
    fromPartial<
      I extends Exact<
        ...
        I
      >,
    >(object: I): SubscribeEntriesRequest_TransactionsEntry {
      const message = createBaseSubscribeEntriesRequest_TransactionsEntry()
      message.key = object.key ?? ''
      message.value =
        object.value !== undefined && object.value !== null
...
export const SubscribeEntriesRequest_SlotsEntry: MessageFns<SubscribeEntriesRequest_SlotsEntry> =
  {
    encode(
      message: SubscribeEntriesRequest_SlotsEntry,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
      if (message.key !== '') {
        writer.uint32(10).string(message.key)
    ...
    fromPartial<
      I extends Exact<DeepPartial<SubscribeEntriesRequest_SlotsEntry>, I>,
    >(object: I): SubscribeEntriesRequest_SlotsEntry {
      const message = createBaseSubscribeEntriesRequest_SlotsEntry()
      message.key = object.key ?? ''
      message.value =
        object.value !== undefined && object.value !== null
...
export const SubscribeRequestFilterAccounts: MessageFns<SubscribeRequestFilterAccounts> =
  {
        ...
        switch (tag >>> 3) {
          ...
          case 4: {
            ...
            message.filters.push(
              SubscribeRequestFilterAccountsFilter.decode(
                reader,
                reader.uint32(),
              ),
            )
    ...
    fromPartial<
      I extends Exact<DeepPartial<SubscribeRequestFilterAccounts>, I>,
    >(object: I): SubscribeRequestFilterAccounts {
      const message = createBaseSubscribeRequestFilterAccounts()
...
export const SubscribeRequestFilterAccountsFilter: MessageFns<SubscribeRequestFilterAccountsFilter> =
  {
    encode(
      ...
      if (message.lamports !== undefined) {
        SubscribeRequestFilterAccountsFilterLamports.encode(
          message.lamports,
          writer.uint32(34).fork(),
        ).join()
      }
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 4: {
            ...
            message.lamports =
              SubscribeRequestFilterAccountsFilterLamports.decode(
                reader,
                reader.uint32(),
              )
            continue
    ...
    fromJSON(object: any): SubscribeRequestFilterAccountsFilter {
      return {
        ...
        lamports: isSet(object.lamports)
          ? SubscribeRequestFilterAccountsFilterLamports.fromJSON(
              object.lamports,
            )
          : undefined,
      }
    ...
    toJSON(message: SubscribeRequestFilterAccountsFilter): unknown {
      ...
      if (message.lamports !== undefined) {
        obj.lamports = SubscribeRequestFilterAccountsFilterLamports.toJSON(
          message.lamports,
        )
      }
      return obj
    ...
    >(base?: I): SubscribeRequestFilterAccountsFilter {
    ...
    >(object: I): SubscribeRequestFilterAccountsFilter {
      ...
      message.memcmp =
        object.memcmp !== undefined && object.memcmp !== null
          ? SubscribeRequestFilterAccountsFilterMemcmp.fromPartial(
              object.memcmp,
            )
          : undefined
      ...
      message.lamports =
        object.lamports !== undefined && object.lamports !== null
          ? SubscribeRequestFilterAccountsFilterLamports.fromPartial(
              object.lamports,
            )
          : undefined
      return message
...
export const SubscribeRequestFilterAccountsFilterMemcmp: MessageFns<SubscribeRequestFilterAccountsFilterMemcmp> =
  {
    ...
    create<
      I extends Exact<
        DeepPartial<SubscribeRequestFilterAccountsFilterMemcmp>,
        I
      >,
...
export const SubscribeRequestFilterAccountsFilterLamports: MessageFns<SubscribeRequestFilterAccountsFilterLamports> =
  {
    ...
    create<
      I extends Exact<
        DeepPartial<SubscribeRequestFilterAccountsFilterLamports>,
        I
      >,
    >(base?: I): SubscribeRequestFilterAccountsFilterLamports {
      return SubscribeRequestFilterAccountsFilterLamports.fromPartial(
        base ?? ({} as any),
      )
    },
    fromPartial<
      I extends Exact<
        ...
        I
      >,
    >(object: I): SubscribeRequestFilterAccountsFilterLamports {
      const message = createBaseSubscribeRequestFilterAccountsFilterLamports()
...
export const Entry: MessageFns<Entry> = {
  ...
  fromJSON(object: any): Entry {
    return {
      ...
      entries: isSet(object.entries)
        ? bytesFromBase64(object.entries)
        : new Uint8Array(0),
    }
  },
...
export const ShredstreamService = {
  ...
  sendHeartbeat: {
    ...
    requestSerialize: (value: Heartbeat) =>
      Buffer.from(Heartbeat.encode(value).finish()),
    requestDeserialize: (value: Buffer) => Heartbeat.decode(value),
    responseSerialize: (value: HeartbeatResponse) =>
      Buffer.from(HeartbeatResponse.encode(value).finish()),
...
export const ShredstreamProxyService = {
  subscribeEntries: {
    ...
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: SubscribeEntriesRequest) =>
      Buffer.from(SubscribeEntriesRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) =>
      SubscribeEntriesRequest.decode(value),
    responseSerialize: (value: Entry) =>
      Buffer.from(Entry.encode(value).finish()),
